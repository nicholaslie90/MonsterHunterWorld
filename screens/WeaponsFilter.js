...
export default class WeaponsFilterScreen extends React.PureComponent {
    constructor() {
        super();
    ...
    static navigationOptions = ({navigation, navigationOptions}) => {
        ...
        return {
            title: I18n.t('ui-filter').Translation + " " +  I18n.t('home-weapons').Translation,
        };
    };
            ...
            <SafeAreaView style={[{flex: 1}, themeBackground]}>
                <ScrollView>
                    <View style={{flex: 1, flexDirection: 'column'}}>
                        ...
                        <FilterItem name={'Kulve Taroth only'} value={'KT'} filterCondition={params.filterCondition}
                                    navigation={this.props.navigation}
                                    updateWeapons={params.updateWeapons}
                                    theme={this.props.navigation.state.params.theme}/>
                        <FilterItem name={'Final Forms'} value={'Final'} filterCondition={params.filterCondition}
                                    navigation={this.props.navigation}
                                    updateWeapons={params.updateWeapons}
                                    theme={this.props.navigation.state.params.theme}/>
                    </View>
