...
export default class EventCalendarScreen extends React.PureComponent {
    state = {
        showAds: true,
    };
    ...
    static navigationOptions = ({navigation, navigationOptions}) => {
        return {
            title: I18n.t('home-event-calendar').Translation,
        };
    };
    ...
    _renderAds() {
        if (this.state.showAds) {
            return makeAdMob('ca-app-pub-9242567842673294/3047837612', 'ca-app-pub-9242567842673294/4054596593');
        } else {
            return null;
        }
    }
